...
using TicketLookupResult = OperationsOneCentre.Interfaces.TicketLookupResult;
using TicketInfo = OperationsOneCentre.Interfaces.TicketInfo;
using TicketComment = OperationsOneCentre.Interfaces.TicketComment;
using SimilarTicketInfo = OperationsOneCentre.Interfaces.SimilarTicketInfo;
...
public class TicketLookupService : ITicketLookupService
{
    ...
    private TicketInfo ConvertToTicketInfo(JiraTicket jiraTicket)
    {
        var info = new TicketInfo
        {
            ...
            JiraUrl = $"{_jiraBaseUrl}/browse/{jiraTicket.Key}",
