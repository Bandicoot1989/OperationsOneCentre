...
public class QueryCacheService
{
    ...
    // Cache configuration (centralized in AppConstants)
    private readonly TimeSpan _queryResultExpiration = AppConstants.Cache.QueryResultExpiration;
    private readonly TimeSpan _embeddingExpiration = AppConstants.Cache.EmbeddingExpiration;
    private readonly TimeSpan _searchResultExpiration = AppConstants.Cache.SearchResultExpiration;
    
    // Semantic cache configuration
    private const double SemanticSimilarityThreshold = AppConstants.Search.SemanticCacheSimilarityThreshold;
    private readonly List<SemanticCacheEntry> _semanticCache = new();
    private readonly object _semanticCacheLock = new();
    private const int MaxSemanticCacheEntries = AppConstants.Limits.MaxSemanticCacheEntries;
    ...
    /// <summary>
    /// Calculate cosine similarity between two vectors (delegates to shared VectorMath)
    /// </summary>
